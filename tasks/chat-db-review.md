...
- plugin review
- group project llm transcript stt
- sensevoice/whisper llm combination
  - check with cantonest-stt, create new temp project, run local
- check vibevoice asr (newer model)
